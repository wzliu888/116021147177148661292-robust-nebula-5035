      ...
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <button
              onClick={() => {
                console.log(`Date clicked: ${monthNames[currentMonth]} ${currentDay}, ${currentYear}`)
                alert(`You clicked on today's date: ${monthNames[currentMonth]} ${currentDay}, ${currentYear}`)
              }}
              className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 transition-colors duration-200 cursor-pointer underline decoration-transparent hover:decoration-emerald-500/50 underline-offset-2"
            >
